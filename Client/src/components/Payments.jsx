                    ...
                    {pendingPayments.length > 0 ? (
                      pendingPayments.map((payment) => (
                        <tr key={payment.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600 font-medium">{payment.amount}</td>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button
                              ...
                              className="text-teal-600 hover:text-teal-900 bg-teal-50 hover:bg-teal-100 px-3 py-1 rounded-md text-sm font-medium transition-colors flex items-center ml-auto"
                            >
