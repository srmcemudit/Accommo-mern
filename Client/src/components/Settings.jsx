    ...
    <div className="max-w-sm mx-auto p-6 bg-transparent shadow-lg rounded-lg">
      ...
      <ul className="space-y-2">
        {options.map((option, index) => (
          ...
          <li key={index} className="flex items-center p-3 rounded-md shadow-sm hover:bg-slate-950 cursor-pointer transition-colors" onClick={() => handleNavigation(option.link)} >
