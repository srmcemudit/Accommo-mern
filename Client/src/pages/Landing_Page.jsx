...
function LandingPage() {
  ...
  return (
    <div className="md:min-h-screen h-dvh bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center 
    md:p-4 p-2">
      {/* Modern card design */}
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100">
        ...
        <div className="md:p-8 p-4">
          ...
          <form onSubmit={handleLogin} className="md:space-y-5 space-y-3">
            {/* Email Field */}
